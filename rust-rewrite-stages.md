...
- [x] Define the `exo.scm` and `modules/**/*.scm` configuration schema.
...
- Ratatui `TestBackend` tests cover the three-pane shell, navigation state, search, preview, actions, conjunctive multi-tag filtering, deletion/restore, and encrypted temporary-file editing.
